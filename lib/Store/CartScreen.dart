      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          return Stack(
            children: [
              ListView.builder(
                padding: const EdgeInsets.only(bottom: 130, top: 16, left: 16, right: 16),
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          Text("\$${data['price']} x ${data['quantity']} = \$${(data['price'] * data['quantity']).toStringAsFixed(2)}"),
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Text("$totalItems", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                          ],
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text("\$${totalPrice.toStringAsFixed(2)}", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                          ],
                        ),
