...
class ShelterUploadProductScreen extends StatefulWidget {
  ...
  @override
  State<ShelterUploadProductScreen> createState() => _ShelterUploadProductScreenState();
}

class _ShelterUploadProductScreenState extends State<ShelterUploadProductScreen> {
          ...
          child: Column(
            children: [
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: _webImageBytes == null
                      ...
                      : ClipRRect(
                    borderRadius: BorderRadius.circular(12),
                    child: Image.memory(_webImageBytes!, fit: BoxFit.cover, width: double.infinity),
                  ),
                ),
              ),
              ...
              ElevatedButton.icon(
                ...
                label: Text(_loading ? "Uploading..." : "Upload", style: const TextStyle(fontSize: 16)),
              ),
            ],
          ),
        ),
